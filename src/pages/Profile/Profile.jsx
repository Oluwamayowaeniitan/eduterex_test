  ...
  return (
    <div className="profile-container">
      <div className="p-top-section">
        <img src={`http://127.0.0.1:8000${user?.passport}`} alt="" srcset="" />
        <div className="p-top-section-right">
          ...
          >
            ...
            <p>
              <span className="p-label">Staff ID: </span>
      ...
      <div className="p-staff-info">
        <div className="p-info-card">
          ...
          <p className="p-value">{user?.full_name}</p>
        </div>
        <div className="p-info-card">
          <p className="p-label">Staff ID</p>
          <p className="p-value">{user?.staff_id}</p>
        </div>
        <div className="p-info-card">
