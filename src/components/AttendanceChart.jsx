...
const AttendanceChart = () => {
  ...
  const [timeFrame, setTimeFrame] = useState("Week 1");
  ...
  useEffect(() => {
    ...
    const studentBySession = schoolTuition?.map(
      (obj) => getStudent(obj.student) || {},
    );
    ...
    const current_week = week_array.find((week) =>
  ...
  return (
    <Box sx={{ overflowX: "auto" }}>
      ...
      >
        <Typography variant="p" gutterBottom style={{ fontWeight: 600 }}>
          Attendance
        </Typography>
